                     ...
                     INT NoofV, INT NoofI, mc6VERTEX *Vertices, INT *Indices)
{
  ...
  glVertexAttribPointer(0, 3, GL_FLOAT, FALSE, sizeof(mc6VERTEX), (VOID *)0); /* позиция */
  glVertexAttribPointer(1, 2, GL_FLOAT, FALSE, sizeof(mc6VERTEX), (VOID *)sizeof(VEC)); /* текстура */
  glVertexAttribPointer(2, 3, GL_FLOAT, FALSE, sizeof(mc6VERTEX), (VOID *)(sizeof(VEC) + sizeof(mc6UV))); /* нормаль */
  glVertexAttribPointer(3, 4, GL_FLOAT, FALSE, sizeof(mc6VERTEX), (VOID *)(sizeof(VEC) * 2 + sizeof(mc6UV))); /* цвет */
